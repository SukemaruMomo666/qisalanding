      ...
      <section className="relative min-h-screen flex flex-col justify-center px-4 md:px-12 lg:px-24 overflow-hidden pt-32 pb-20">
            ...
            >
              ...
              <h1 className="relative">
                ...
                <motion.span
                  ...
                  className="block text-responsive-h1 font-heading font-black uppercase tracking-tighter"
                >
                  {t("hero.perfection")}<span className="text-accent">.</span>
                </motion.span>
              </h1>
        ...
        >
          <h2 className="text-[30vw] md:text-[25vw] font-heading font-black uppercase leading-none whitespace-nowrap -mb-5 md:-mb-10 opacity-50">
            {t("hero.background_text")} {t("hero.background_text")}
          </h2>
        </motion.div>
        ...
        >
          ...
          <span>{t("hero.interactive_hint")}</span>
        </motion.div>
      </section>
        ...
        >
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-center">
              <span className="text-lg md:text-3xl font-heading font-black uppercase mx-8 md:mx-16">{t("marquee.architecture")}</span>
              <span className="w-2 h-2 md:w-3 md:h-3 bg-accent rotate-45" />
              <span className="text-lg md:text-3xl font-heading font-black uppercase mx-8 md:mx-16">{t("marquee.ui")}</span>
              <span className="w-2 h-2 md:w-3 md:h-3 bg-accent rotate-45" />
              <span className="text-lg md:text-3xl font-heading font-black uppercase mx-8 md:mx-16">{t("marquee.elite")}</span>
              <span className="w-2 h-2 md:w-3 md:h-3 bg-accent rotate-45" />
            </div>
          ))}
        </motion.div>
